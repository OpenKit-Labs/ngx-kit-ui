...
@Component({
  ...
  standalone: true,
  imports: [KitLayoutModule, KitButtonModule, KitTextModule, CodeBlockComponent, SimpleTableComponent, FormsModule],
  templateUrl: './radio-buttons.component.html',
  styleUrls: ['./radio-buttons.component.scss']
})
export class RadioButtonsComponent {
  importModule = `import { KitButtonModule } from '@openkit-labs/ngx-kit-ui';`;
  importComponent = `import { KitRadioButtonComponent } from '@openkit-labs/ngx-kit-ui';`;
  usage = `<kit-radio-button color="primary"></kit-radio-button>`;
  ...
  inputsDataset = [
    ...
    { input: 'active', type: 'boolean', default: 'false', description: 'Whether the button is active or not.' }
  ];
  ...
  outputsDataset = [
    { output: 'activeChange', type: 'EventEmitter<boolean>', description: 'Emitted when the button active state changes.' }
  ];
