...
export class GridComponent {
  ...
  usage = `<kit-grid [cols]="3" [rows]="2" [gap]="16">
  <!-- Your content here -->
</kit-grid>`;

  // Example 1: Fixed Grid
  example1Code = `<kit-grid [cols]="3" [gap]="16">
  ...
  example2Code = `<kit-grid [minColWidth]="'200px'" [maxColWidth]="'1fr'" [gap]="16">
  ...
  example3Code = `<kit-grid [cols]="2" [rows]="2" [gap]="16" 
  ...
  inputsDataset = [
    ...
    { input: 'gap', type: 'SpacingValue', default: "undefined", description: 'The gap between grid items in predefined spacing values (0, 4, 8, 16, 24, 32). This is a shorthand for rowGap and colGap.' },
