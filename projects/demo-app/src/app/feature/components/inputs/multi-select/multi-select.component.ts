...
export class MultiSelectComponent {
  ...
  importComponent = `import { KitInputMultiSelectComponent } from ' @openkit-labs/ngx-kit-ui';`;
  usage = `<kit-input-multi-select title="Select an Option" placeholder="Choose an item" [options]="options" [(value)]="selectedValue"></kit-input-multi-select>

<!-- With Search -->
<kit-input-multi-select title="Select a User" [options]="users" [showSearch]="true" [(value)]="selectedValue"></kit-input-multi-select>

<!-- With Custom Templates -->
<kit-input-multi-select title="Select a User" [options]="users" [(value)]="selectedValue">
  ...
  inputsDataset = [
    ...
    { input: 'value', type: 'any[]', default: '[]', description: 'The current value of the select.' },
